...
public static class CommonExtensions
{
    ...
    /// <summary>
    ///     Return a path that is guaranteed to work on the platform, if it's unix or windows based.
    /// </summary>
    public static string NormalizePath(this string self) => Path.Combine(self.Split('\\'));
